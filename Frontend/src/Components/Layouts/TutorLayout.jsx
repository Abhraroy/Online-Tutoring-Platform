...
const TutorLayout = () => {
  ...
  return (
    <div className="h-[100vh] flex flex-col overflow-x-hidden overflow-y-auto ">
      {/* Navbar */}
        ...
        {isOpen && (
          <div className="md:hidden border-t border-gray-200 bg-white">
            <nav className="px-4 pb-4 pt-2 space-y-1">
              <NavLink to="/tutor-home" className={({ isActive }) => `block rounded-md px-3 py-2 text-base font-medium ${isActive ? 'bg-indigo-50 text-indigo-700' : 'text-gray-700 hover:bg-gray-50'}`} onClick={() => setIsOpen(false)}>Home</NavLink>
      ...
      {/* Content */}
      <div className="w-[100vw] h-[90vh] flex justify-center items-start">
          <Outlet />
        </div>
    </div>
  );
