...
function FindTutor() {
  ...
  const [hiringTutorId, setHiringTutorId] = useState(null);
        ...
        {tutors.length === 0 ? (
          ...
          <div className="flex md:grid md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-6 overflow-x-auto md:overflow-visible pb-4 md:pb-0 snap-x md:snap-none snap-mandatory">
            {tutors.map((tutor) => (
              <div
                key={tutor._id}
                className="bg-white rounded-lg border border-gray-200 shadow-sm hover:shadow-md transition-shadow duration-200 p-6 min-w-[260px] sm:min-w-[300px] md:min-w-0 snap-start flex flex-col h-full"
              >
                ...
                <div className="flex-1 flex flex-col">
                  ...
                  {/* Subjects - Always show with consistent height */}
                ...
                <div className="flex gap-3 pt-4 mt-auto border-t border-gray-100">
                  ...
                  <button
                    ...
                    disabled={hiringTutorId === tutor._id}
                    className={`flex-1 px-4 py-2.5 bg-gray-900 text-white rounded-lg font-medium text-sm hover:bg-gray-800 transition-all duration-200 active:scale-95 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:bg-gray-900`}
                  >
                    {hiringTutorId === tutor._id ? (
                      <>
